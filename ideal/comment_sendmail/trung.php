...
function ying (){
	...
	$strMessage  = "<B>วันที่ :</B>&nbsp;".$dateday = date("d-m-Y")
			."<br/></br>"
			."<br/></br><B>แนะนำสาขาตรัง</B>  :"."<br/><br/>".$_POST["c_branch"]
			."<br/></br>"
			."<br/></br>..................................................................."
			."<br/></br><B>สุนิสา พลายด้วง (โอ)</B>  :"."<br/><br/>".$_POST["cstaff1"]
			."<br/></br>"
			."<br/></br>..................................................................."
			."<br/></br><B>จิรารัตน์ ศรีนิลดำ (น้ำ)</B>  :"."<br/><br/>".$_POST["cstaff2"]
			."<br/></br>"
	...
	$strHeader = "";
	$strHeader .= "From:"."ข้อเสนอแนะ สาขาตรัง :".$_POST["branch"]."\nReply-To: ".$_POST["name"]."";
